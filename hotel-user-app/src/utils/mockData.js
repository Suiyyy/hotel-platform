const mockHotels = [
  ...
  },
  {
    id: "6",
    nameCn: "三亚湾海景度假酒店",
    nameEn: "Sanya Bay Seaview Resort Hotel",
    address: "海南省三亚市三亚湾路88号",
    star: 5,
    price: 1288,
    openDate: "2021-11-01",
    imageUrl: "https://picsum.photos/seed/hotel6/400/300",
    phone: "0898-88888888",
    description: "一线海景，私人沙滩，度假胜地",
    roomTypes: [
      { id: "6-1", name: "海景大床房", price: 1288, area: 45, bedType: "2.0米大床" },
      { id: "6-2", name: "海景套房", price: 2588, area: 80, bedType: "2.0米大床" }
    ],
    rating: 4.9,
    distance: 0.3,
    facilities: ["免费WiFi", "停车场", "私人沙滩", "游泳池", "健身房", "餐厅"],
    status: "approved",
    rejectReason: "",
    isOnline: true,
  ...
  },
  {
    id: "7",
    nameCn: "厦门鼓浪屿民宿",
    nameEn: "Xiamen Gulangyu Homestay",
    address: "福建省厦门市思明区鼓浪屿漳州路20号",
    star: 3,
    price: 388,
    openDate: "2022-05-15",
    imageUrl: "https://picsum.photos/seed/hotel7/400/300",
    phone: "0592-12345678",
    description: "文艺小清新，鼓浪屿特色民宿",
    roomTypes: [
      { id: "7-1", name: "标准房", price: 388, area: 22, bedType: "1.5米大床" },
      { id: "7-2", name: "海景房", price: 458, area: 26, bedType: "1.5米大床" }
    ],
    rating: 4.4,
    distance: 0.6,
    facilities: ["免费WiFi", "餐厅"],
  ...
  },
  {
    id: "8",
    nameCn: "西安钟楼酒店",
    nameEn: "Xi'an Bell Tower Hotel",
    address: "陕西省西安市碑林区东大街1号",
    star: 4,
    price: 528,
    openDate: "2020-09-20",
    imageUrl: "https://picsum.photos/seed/hotel8/400/300",
    phone: "029-87654321",
    description: "紧邻西安钟楼，感受古都魅力",
    roomTypes: [
      { id: "8-1", name: "钟楼景房", price: 528, area: 32, bedType: "1.8米大床" },
      { id: "8-2", name: "标准双床房", price: 498, area: 30, bedType: "2张1.2米床" }
    ],
    rating: 4.7,
    distance: 1.8,
  ...
  },
  {
    id: "9",
    nameCn: "广州天河城酒店",
    nameEn: "Guangzhou Teemall Hotel",
    ...
    phone: "020-12345678",
    description: "位于天河商业中心，购物便利",
    roomTypes: [
      { id: "9-1", name: "豪华大床房", price: 788, area: 40, bedType: "1.8米大床" },
      { id: "9-2", name: "行政套房", price: 1388, area: 60, bedType: "2.0米大床" }
    ],
    rating: 4.6,
    distance: 2.2,
    facilities: ["免费WiFi", "停车场", "健身房", "游泳池", "餐厅", "商务中心"],
  ...
  },
  {
    id: "10",
    nameCn: "南京夫子庙酒店",
    nameEn: "Nanjing Confucius Temple Hotel",
    address: "江苏省南京市秦淮区贡院街1号",
    star: 4,
    price: 418,
    openDate: "2021-07-15",
    imageUrl: "https://picsum.photos/seed/hotel10/400/300",
    phone: "025-87654321",
    description: "紧邻夫子庙景区，感受秦淮河夜景",
    roomTypes: [
      { id: "10-1", name: "河景房", price: 418, area: 30, bedType: "1.5米大床" },
      { id: "10-2", name: "标准房", price: 388, area: 28, bedType: "1.5米大床" }
    ],
    rating: 4.5,
    distance: 0.9,
    facilities: ["免费WiFi", "停车场", "餐厅"],
