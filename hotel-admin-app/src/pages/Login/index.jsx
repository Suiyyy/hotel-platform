...
import { Form, Input, Button, Card, message, Tabs, Radio, Alert } from 'antd'
      ...
      children: (
        <div>
          ...
          <Alert
            ...
            showIcon
            message="测试账号"
            description={<>管理员：admin / 123456<br />商户：user / 123456</>}
            style={{ marginTop: 16 }}
          />
        </div>
      ),
      ...
      children: (
        <div>
          <Form name="register" onFinish={handleRegister} autoComplete="off" size="large">
            ...
            <Form.Item name="role" initialValue="user" label="注册角色" rules={[{ required: true, message: '请选择角色' }]}>
              <Radio.Group>
